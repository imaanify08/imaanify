...
// Update the SignupSchema schema to include gender
...
const SignupForm = () => {
  ...
  const handleSignup = async (user: z.infer<typeof SignupSchema>) => {
    try {
      ...
      const newUser = await createUserAccount({ ...user, gender: user.gender });
    ...
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-regular mt-2">
          To use imaanify, Please enter your details
        </p>
